...
- (NSSet *)dataTypesToWrite {
    ...
    return [NSSet setWithObjects:dietaryCalorieEnergyType, activeEnergyBurnType, heightType, weightType,heartType, nil];
}
...
- (NSSet *)dataTypesToRead {
    ...
    return [NSSet setWithObjects:dietaryCalorieEnergyType, activeEnergyBurnType, heightType, weightType, birthdayType, biologicalSexType,heartType,nil];
}
